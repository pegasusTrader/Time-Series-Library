...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='./stockdata/train/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='000001.SZ_180s.csv', help='data file')
